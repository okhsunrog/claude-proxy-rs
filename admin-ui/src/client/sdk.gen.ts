 ...
 */
export const getMyByModel = <ThrowOnError extends boolean = false>(options?: Options<GetMyByModelData, ThrowOnError>) => (options?.client ?? client).get<GetMyByModelResponses, GetMyByModelErrors, ThrowOnError>({ url: '/usage/history/by-model', ...options });

/**
 * Get cost/token timeseries for the authenticated key
 */
export const getMyTimeseries = <ThrowOnError extends boolean = false>(options?: Options<GetMyTimeseriesData, ThrowOnError>) => (options?.client ?? client).get<GetMyTimeseriesResponses, GetMyTimeseriesErrors, ThrowOnError>({ url: '/usage/history/timeseries', ...options });

/**
 * Get current usage and limits for the authenticated key
 */
export const getMyUsage = <ThrowOnError extends boolean = false>(options?: Options<GetMyUsageData, ThrowOnError>) => (options?.client ?? client).get<GetMyUsageResponses, GetMyUsageErrors, ThrowOnError>({ url: '/usage/me', ...options });
